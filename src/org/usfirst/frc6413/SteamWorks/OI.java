...
import org.usfirst.frc6413.SteamWorks.subsystems.*;
...
public class OI {
    ...
    public OI() {
        ...
        clawButton.whenPressed(new JawsClose(false));
        ...
        gearSwitch.whenPressed(new JawsClose(true));
        ...
        SmartDashboard.putData("Jaws Close", new JawsClose(false));
